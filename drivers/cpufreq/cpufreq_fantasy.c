...
static void do_dbs_timer(struct work_struct *work)
{
    ...
    switch (fantasy_dbs_info.step) {
        ...
        case CPUFREQ_FANTASY_STEP3: {
            ...
            wall_time = (unsigned int) (cur_wall_time - fantasy_dbs_info.prev_cpu_wall);
            idle_time = (unsigned int) (cur_idle_time - fantasy_dbs_info.prev_cpu_idle);
            iowait_time = (unsigned int) (cur_iowait_time - fantasy_dbs_info.prev_cpu_iowait);
