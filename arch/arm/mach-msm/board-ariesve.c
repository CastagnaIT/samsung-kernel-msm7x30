...
#else
#define MSM_PMEM_SF_SIZE	0x1700000 /*stock value 0x1A00000*/
#endif
...
#else
#define MSM_PMEM_ADSP_SIZE		0x29D0000  /*stock value 0x2D00000*/
#endif
...
static int display_common_init(void)
{
	struct regulator_bulk_data regs[2] = {
		{ .supply = "ldo17", .min_uV = 1600000, .max_uV = 1600000},
